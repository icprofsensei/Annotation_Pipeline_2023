...
import os
array = []
tsv = open('NCBI_taxonomy_dictionary_v4.tsv', 'r')
...
with open("NCBI_tax_dictionary2.json", "w") as e:
    json.dump(newdata, e, indent = 4)

if os.path.isfile('NCBI_tax_dictionary2.json') == True:
                 os.remove('NCBI_TAX_DIC')